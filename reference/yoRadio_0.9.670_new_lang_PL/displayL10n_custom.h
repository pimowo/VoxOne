...
const char       bootstrFmt[]    PROGMEM = "Łączę %s";
const char        apSettFmt[]    PROGMEM = "SETTINGS PAGE ON: HTTP://%s/";

#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 odczuwalna: %.1f\011C \007 ciśnienie: %d мм \007 wilgotność: %d%% \007 wiatr: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 ciśnienie: %d mm \007 wilgotność: %d%%";
#endif
