...
const WidgetConfig playlistHeaderConf  PROGMEM = { 0, 2, 2, WA_CENTER };
const WidgetConfig playlistCounterConf PROGMEM = { 0, 60, 1, WA_CENTER };
const WidgetConfig playlistPlayingConf PROGMEM = { 4, 60, 1, WA_RIGHT };
