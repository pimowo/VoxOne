...
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 48, 2, WA_LEFT }, 140, MAX_WIDTH-TITLE_FIX, 5000, 4, 30 };
...
const ScrollConfig apSettConf     PROGMEM = {{ TFT_FRAMEWDT, 240-TFT_FRAMEWDT-16, 2, WA_LEFT }, 140, MAX_WIDTH, 0, 4, 30 };
