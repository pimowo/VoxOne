...
const ScrollConfig title1Conf     PROGMEM = {{ 0, 20, 1, WA_LEFT }, 140, DSP_WIDTH/2+2, 5000, 2, 25 };
const ScrollConfig title2Conf     PROGMEM = {{ 0, 29, 1, WA_LEFT }, 140, DSP_WIDTH/2+2, 5000, 2, 25 };
